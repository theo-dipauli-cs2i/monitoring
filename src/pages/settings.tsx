            ...
            <Box>
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                <input
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                    themeContext?.setPrimaryColor(e.currentTarget.value)
                  }
                  style={{
                    width: 60,
                    height: 60,
            ...
            <Box>
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                <input
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                    themeContext?.setSecondaryColor(e.currentTarget.value)
                  }
                  style={{
                    width: 60,
                    height: 60,
          ...
          <Stack spacing={1} sx={{ mt: 2 }}>
            ...
            <FormControlLabel
              control={
                <Checkbox
                  checked={
                    themeContext?.menuItemsVisibility?.['monitoring'] !== false
                  }
