...
export const ChartVisibilityContext = createContext<ChartVisibilityContextType | undefined>(undefined);

export function ChartVisibilityProvider({ children }: { children: any }) {
    const [chartVisibility, setChartVisibilityState] = useState<Record<string, boolean>>({
        clientChart: true,
        commandeChart: true,
    ...
    return (
        <ChartVisibilityContext.Provider value={{ chartVisibility, setChartVisibility }}>
            {children}
